...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Item item = new Item();
        item.imageRes = R.drawable.grade1huzhang;
        item.text = "虎杖";
        mList.add(item);
        item = new Item();
        ...
        circleMenuLayout.setOnItemClickListener(new CircleMenuLayout.OnItemClickListener() {
            ...
            public void onItemClickListener(View v, int position) {
                Intent detailIntent = new Intent(DetailActivity.this, PersonDetailActivity.class);
                detailIntent.putExtra("title", mList.get(position).text);
                startActivity(detailIntent);
//                Toast.makeText(DetailActivity.this, mList.get(position).text + "", Toast.LENGTH_SHORT).show();
            }
        });
    }
